(function () {
  ...
  const messages = {
    en: {
      ...
      "首次启动前完成常用配置；添加后仍可在详情页调整可修改项。": "Configure the common options before first start. Editable options remain available on the details page after adding.",
      "所有可用游戏都已添加。": "All available games have been added.", "游戏已经添加，无需再次初始化": "This game has already been added and does not need to be set up again.",
      ...
      "删除": "Delete", "请确认": "Please confirm", "取消": "Cancel", "确认删除": "Delete permanently",
      "将停止服务器，并永久删除世界、模组、备份和容器。此操作无法恢复。": "The server will stop, and the world, mods, backups, and container will be permanently deleted. This cannot be undone.",
      ...
      "黑名单": "Ban list", "加入黑名单": "Add to ban list", "移出黑名单": "Remove from ban list", "访问控制": "Access control", "名单管理": "List management",
      "输入 Minecraft 玩家名": "Enter a Minecraft player name", "加入名单": "Add to list", "移除": "Remove", "当前名单为空。": "This list is empty.",
      "启动服务器后可以添加或移除名单成员。": "Start the server to add or remove list members.", "名单修改会立即写入 Minecraft 服务器。": "List changes are written to the Minecraft server immediately.",
      "确定将该玩家加入黑名单吗？": "Add this player to the ban list?", "服务器初始化后不可修改；如需更换，请删除服务器数据后重新初始化": "Locked after server setup. To change it, delete the server data and set up again.",
      ...
      "拖拽 .jar 到此处，或点击选择": "Drop .jar files here, or click to choose",
      "支持同时选择多个 Mod 文件": "You can select multiple mod files at once",
      "正在上传 Mod": "Uploading mods", "准备上传": "Ready to upload", "正在添加游戏": "Adding game",
      "正在保存游戏配置": "Saving game settings", "等待中": "Waiting", "上传中": "Uploading", "完成": "Done", "失败": "Failed",
      ...
      "保留份数": "Backups to keep", "份": "backups", "保存设置": "Save settings", "保存中": "Saving",
      "正在保存备份设置": "Saving backup settings", "备份设置已保存": "Backup settings saved",
      "允许保留 1–30 份；调低后会立即清理超出的旧备份": "Keep 1–30 backups. Lowering this immediately removes excess older backups.",
      "允许 1–720 小时，最低 1 小时，避免过于频繁地压缩存档": "Allowed range: 1–720 hours. The one-hour minimum prevents excessively frequent archive creation.",
      "仅影响后续自动备份，无需重启游戏服务器。": "Applies to future automatic backups without restarting the game server.",
      ...
      "容器启动后立即退出": "The container exited immediately after start",
      "容器启动后无法读取状态": "Could not read the container status after start",
    ...
    "zh-TW": {
      ...
      "首次启动前完成常用配置；添加后仍可在详情页调整可修改项。": "首次啟動前完成常用設定；新增後仍可在詳情頁調整可修改項目。", "所有可用游戏都已添加。": "所有可用遊戲都已新增。", "游戏已经添加，无需再次初始化": "遊戲已經新增，無需再次初始化。",
      ...
      "停止": "停止", "重启": "重新啟動", "启动": "啟動", "详情": "詳情",
      "删除": "刪除", "请确认": "請確認", "取消": "取消", "确认删除": "確認刪除",
      "将停止服务器，并永久删除世界、模组、备份和容器。此操作无法恢复。": "將停止伺服器，並永久刪除世界、模組、備份和容器。此操作無法恢復。", "版本": "版本", "加载器": "載入器", "连接端口": "連線連接埠", "内存": "記憶體", "文件": "檔案",
      ...
      "黑名单": "黑名單", "加入黑名单": "加入黑名單", "移出黑名单": "移出黑名單", "访问控制": "存取控制", "名单管理": "名單管理", "输入 Minecraft 玩家名": "輸入 Minecraft 玩家名稱", "加入名单": "加入名單", "移除": "移除", "当前名单为空。": "目前名單為空。", "启动服务器后可以添加或移除名单成员。": "啟動伺服器後可以新增或移除名單成員。", "名单修改会立即写入 Minecraft 服务器。": "名單修改會立即寫入 Minecraft 伺服器。", "确定将该玩家加入黑名单吗？": "確定將該玩家加入黑名單嗎？", "服务器初始化后不可修改；如需更换，请删除服务器数据后重新初始化": "伺服器初始化後不可修改；如需更換，請刪除伺服器資料後重新初始化",
      ...
      "拖拽 .jar 到此处，或点击选择": "將 .jar 拖放到此處，或點選選擇", "支持同时选择多个 Mod 文件": "可同時選擇多個 Mod 檔案",
      "正在上传 Mod": "正在上傳 Mod", "准备上传": "準備上傳", "正在添加游戏": "正在新增遊戲",
      "正在保存游戏配置": "正在儲存遊戲設定", "等待中": "等待中", "上传中": "上傳中", "完成": "完成", "失败": "失敗",
      ...
      "自动周期": "自動週期", "每 3 天": "每 3 天", "保留份数": "保留份數", "份": "份", "保存设置": "儲存設定", "保存中": "儲存中",
      "正在保存备份设置": "正在儲存備份設定", "备份设置已保存": "備份設定已儲存", "允许保留 1–30 份；调低后会立即清理超出的旧备份": "允許保留 1–30 份；調低後會立即清理超出的舊備份", "允许 1–720 小时，最低 1 小时，避免过于频繁地压缩存档": "允許 1–720 小時，最低 1 小時，避免過於頻繁地壓縮存檔", "仅影响后续自动备份，无需重启游戏服务器。": "僅影響後續自動備份，無需重新啟動遊戲伺服器。", "容器": "容器", "运行状态": "運行狀態", "健康状态": "健康狀態", "容器当前没有输出": "容器目前沒有輸出", "暂无操作记录": "暫無操作記錄",
    ...
    ja: {
      ...
      "首次启动前完成常用配置；添加后仍可在详情页调整可修改项。": "初回起動前に一般設定を完了します。追加後も詳細ページで変更可能な項目を調整できます。", "所有可用游戏都已添加。": "利用可能なゲームはすべて追加済みです。", "游戏已经添加，无需再次初始化": "このゲームは追加済みのため、再設定は不要です。",
      ...
      "停止": "停止", "重启": "再起動", "启动": "起動", "详情": "詳細",
      "删除": "削除", "请确认": "確認してください", "取消": "キャンセル", "确认删除": "削除する",
      "将停止服务器，并永久删除世界、模组、备份和容器。此操作无法恢复。": "サーバーを停止し、ワールド、Mod、バックアップ、コンテナを完全に削除します。この操作は元に戻せません。", "版本": "バージョン", "加载器": "ローダー", "连接端口": "接続ポート", "内存": "メモリ", "文件": "ファイル",
      ...
      "黑名单": "BAN リスト", "加入黑名单": "BAN リストに追加", "移出黑名单": "BAN リストから削除", "访问控制": "アクセス制御", "名单管理": "リスト管理", "输入 Minecraft 玩家名": "Minecraft プレイヤー名を入力", "加入名单": "リストに追加", "移除": "削除", "当前名单为空。": "現在このリストは空です。", "启动服务器后可以添加或移除名单成员。": "サーバーを起動するとリストのメンバーを追加・削除できます。", "名单修改会立即写入 Minecraft 服务器。": "リストの変更は Minecraft サーバーに即時反映されます。", "确定将该玩家加入黑名单吗？": "このプレイヤーを BAN リストに追加しますか？", "服务器初始化后不可修改；如需更换，请删除服务器数据后重新初始化": "サーバー初期化後は変更できません。変更するにはサーバーデータを削除して再初期化してください。",
      ...
      "拖拽 .jar 到此处，或点击选择": ".jar をここにドロップ、またはクリックして選択", "支持同时选择多个 Mod 文件": "複数の Mod ファイルを同時に選択できます",
      "正在上传 Mod": "Mod をアップロード中", "准备上传": "アップロード準備中", "正在添加游戏": "ゲームを追加中",
      "正在保存游戏配置": "ゲーム設定を保存中", "等待中": "待機中", "上传中": "アップロード中", "完成": "完了", "失败": "失敗",
      ...
      "保留份数": "保持数", "份": "件", "保存设置": "設定を保存", "保存中": "保存中", "正在保存备份设置": "バックアップ設定を保存中", "备份设置已保存": "バックアップ設定を保存しました", "允许保留 1–30 份；调低后会立即清理超出的旧备份": "1～30 件を保持できます。数を減らすと超過した古いバックアップを直ちに削除します。", "允许 1–720 小时，最低 1 小时，避免过于频繁地压缩存档": "1～720 時間で設定できます。頻繁な圧縮を避けるため最短は 1 時間です。", "仅影响后续自动备份，无需重启游戏服务器。": "今後の自動バックアップにのみ適用され、ゲームサーバーの再起動は不要です。",
      ...
      "容器启动后立即退出": "コンテナが起動直後に終了しました",
      "容器启动后无法读取状态": "起動後にコンテナ状態を読み取れませんでした"
    }
  };
  ...
  const patterns = {
    en: [
      ...
      [/^正在上传 (.+)$/, "Uploading $1"], [/^删除 (.+)？$/, "Delete $1?"], [/^准备删除 (.+)$/, "Preparing to delete $1"], [/^开始删除 (.+)$/, "Beginning delete: $1"],
      [/^已删除 (.+)，世界、模组和备份已清除$/, "Deleted $1. World, mods, and backups were removed."],
      [/^正在删除 (.+)$/, "Deleting $1"], [/^确定删除 Mod“(.+)”吗？$/, "Delete mod “$1”?"],
      [/^已添加 (\d+) 个 Mod，重启服务器后生效$/, "Added $1 mods. Restart the server for them to take effect."],
      [/^已添加 (.+)，重启服务器后生效$/, "Added $1. Restart the server for it to take effect."],
      [/^已添加 (\d+) 个 Mod，后续上传失败：(.+)$/, "Added $1 mods, then upload failed: $2"],
      ...
      [/^容器启动后立即退出（退出码 (.+)）$/, "The container exited immediately after start (exit code $1)"],
      [/^容器 (.+) 启动后无法读取状态$/, "Could not read status for container $1 after start"]
    ],
    "zh-TW": [
      ...
      [/^(.+) · 更新于 (.+)$/, "$1 · 更新於 $2"], [/^正在上传 (.+)$/, "正在上傳 $1"], [/^删除 (.+)？$/, "刪除 $1？"], [/^准备删除 (.+)$/, "準備刪除 $1"],
      [/^已删除 (.+)，世界、模组和备份已清除$/, "已刪除 $1，世界、模組和備份已清除"],
      [/^正在删除 (.+)$/, "正在刪除 $1"], [/^确定删除 Mod“(.+)”吗？$/, "確定刪除 Mod「$1」嗎？"],
      [/^已添加 (\d+) 个 Mod，重启服务器后生效$/, "已新增 $1 個 Mod，重新啟動伺服器後生效"],
      [/^已添加 (.+)，重启服务器后生效$/, "已新增 $1，重新啟動伺服器後生效"],
      [/^已添加 (\d+) 个 Mod，后续上传失败：(.+)$/, "已新增 $1 個 Mod，後續上傳失敗：$2"],
      ...
      [/^容器启动后立即退出（退出码 (.+)）$/, "容器啟動後立即退出（退出碼 $1）"],
      [/^容器 (.+) 启动后无法读取状态$/, "容器 $1 啟動後無法讀取狀態"]
    ],
    ja: [
      ...
      [/^(.+) · 更新于 (.+)$/, "$1 · $2 に更新"], [/^正在上传 (.+)$/, "$1 をアップロード中"], [/^删除 (.+)？$/, "$1 を削除しますか？"], [/^准备删除 (.+)$/, "$1 の削除を準備中"],
      [/^已删除 (.+)，世界、模组和备份已清除$/, "$1 を削除しました。ワールド、Mod、バックアップは消去済みです"],
      [/^正在删除 (.+)$/, "$1 を削除中"], [/^确定删除 Mod“(.+)”吗？$/, "Mod「$1」を削除しますか？"],
      [/^已添加 (\d+) 个 Mod，重启服务器后生效$/, "$1 個の Mod を追加しました。再起動後に有効になります"],
      [/^已添加 (.+)，重启服务器后生效$/, "$1 を追加しました。再起動後に有効になります"],
      [/^已添加 (\d+) 个 Mod，后续上传失败：(.+)$/, "$1 個の Mod を追加しましたが、続きのアップロードに失敗：$2"],
      ...
      [/^容器启动后立即退出（退出码 (.+)）$/, "コンテナが起動直後に終了しました（終了コード $1）"],
      [/^容器 (.+) 启动后无法读取状态$/, "コンテナ $1 の起動後に状態を読み取れませんでした"]
    ]
  };
